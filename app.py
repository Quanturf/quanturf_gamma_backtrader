...
import quanturf_backtrader.configuration as oc
import quanturf_backtrader.backend as ob
...
server = app.server
app.title = 'Quanturf - Backtrader app'
...
app.layout = html.Div([
    html.Div(
        html.Div(html.H1('Quanturf - Backtesting app'), className='gray-block2 mb-10'),
